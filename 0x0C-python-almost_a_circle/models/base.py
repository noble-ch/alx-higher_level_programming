...
class Base:
    ...
    def to_json_string(list_dictionaries):
        """returns the representation of a list of dictionaries in JSON string """
    ...
    def from_json_string(json_string):
        """returns the representation json_string in list of the JSON string """
    ...
    def save_to_file(cls, list_objs):
        """evaluates the JSON string representation of list_objs to a file"""
